...
set mochHeaderCmd = `which mockHeader`
if( $mockHeaderCmd == "" ) then
    set mockHeaderCmd = "./mockHeader/mockHeader"
...
foreach loop (`seq 0 $nloops`)
    ...
    udp2fil_cywrapper.py -infile $file -start $hd -readlength $chunksize -o $outfile -I $stokesI -V $stokesV -sumSize $timeWindow -fftSize $fftWindow -t $ncores_avail -p $startport -n $nports
